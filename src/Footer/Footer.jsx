        ...
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex items-center mt-1 space-x-3">
              ...
              <a
                href="/"
                className="text-red-400 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
              ...
              <a
                href="/"
                className="text-blue-400 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
